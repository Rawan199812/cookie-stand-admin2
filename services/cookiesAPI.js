...
export const apiUrl = 'https://cookies-stand.herokuapp.com/api/v1/book/';
...
export async function getToken(values) {
    const url = "https://cookies-stand.herokuapp.com/api/token/";

    const response = await axios.post(url, values);

    const refreshUrl = "https://cookies-stand.herokuapp.com/token/refresh";
